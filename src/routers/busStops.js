...
router.get('/', checktoken ,busStop.getBusStops);
...
router.get('/:busStopId', checktoken , busStop.oneStop);
...
router.post('/', checktoken  , isNotDriver  ,busStop.createBusStop);
...
router.patch('/:busStopId' , checktoken , isNotDriver ,busStop.updateBusStop);
 ...
 *     description: Internal server error
 */
router.delete('/:busStopId', checktoken , isNotDriver , busStop.deleteBusStop);
